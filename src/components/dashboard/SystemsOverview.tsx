    ...
    return (
        <div className={cn('bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden animate-fade-in', className)}>
            ...
            <div className="p-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
                <h3 className="text-lg font-semibold">Vue d&apos;ensemble du syst�me</h3>
                <p className="text-sm text-indigo-100 mt-1">
                    Votre syst�me d&apos;habitudes bas� sur l&apos;identit�
                </p>
            </div>
            ...
            {identity && (
                <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-purple-50">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="text-xs font-medium text-indigo-600 uppercase">Identit� cible</span>
            ...
            <div className="p-4 border-b border-gray-200">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700">Sant� du syst�me</span>
                    <span className={cn(
                        'text-sm font-bold',
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
                <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-gray-500">S�ries totales</div>
                    </div>
                </div>
            </div>
        </div>
...
function getHealthMessage(score: number): string {
    if (score >= 80) return 'Excellent ! Votre syst�me est solide et bien �tabli.';
    if (score >= 60) return 'Bon travail ! Continuez � renforcer vos habitudes.';
    if (score >= 40) return 'En progression. Focalisez-vous sur la constance.';
    return 'D�but du parcours. Commencez petit et soyez r�gulier.';
}
